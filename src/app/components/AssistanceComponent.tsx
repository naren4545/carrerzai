  ...
  return (
    <div className="max-w-xs mx-auto">
      ...
      <div className="border rounded-md shadow-xl mb-4">
        <div className='p-6 border-b text-2xl text-[#FF6700]' onClick={toggleDropdown}>
      ...
      <div className=" border-[0.5px] rounded-md border-black p-6 text-center">
        ...
        <button className="mt-4 px-6 py-2 bg-yellow-500 text-white font-semibold rounded hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-400">
          Contact Now
        </button>
      </div>
    </div>
