...
<h1 className='font-py font-semibold lg:text-6xl text-4xl relative pb-4 max-w-[889px] mx-auto lg:leading-[76px]'>Bridging the Gap <br></br>
Between Talent and Opportunity <div className='bg-[linear-gradient(180deg,_transparent_50%,_#FFBA00_100%)] absolute w-full h-[50px] bottom-[10px]'></div></h1>
