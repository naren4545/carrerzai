...
import { useJobsContext } from './UrlContex'; // Adjust the path as necessary
...
const JobList = () => {
  const { jobs, page, totalPages, setPage, loading } =useJobsContext();
...
you're interested in. " onButtonClick={()=>{}}  imgUrl={folow.src}/>
